...
function Party() {
  ...
  return (
    <div className="bg-white">
      <NavigationMenu />
      <section className="overflow-hidden bg-[url(https://4.bp.blogspot.com/-ubs5q1zeRHo/UiTqfE8girI/AAAAAAAAPBg/sRJwIIKYd4Y/s1600/261.JPG)] bg-cover bg-center bg-no-repeat">
        <div className="bg-black/60 p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="text-center sm:text-left">
            ...
            <div className="text-center">
              {/* <Photographerfilter /> */}
              <p className="text-5xl text-white">Party</p>
            </div>
          </div>
        </div>
      </section>
